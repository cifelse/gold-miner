...
public class MainMenuController extends Controller{
    ...
    public void updateGoldButton() {
        ...
        ImageView icon = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/gold.png")));
    ...
    public void addPitButton() {
        ...
        ImageView icon = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/pit.png")));
        icon.setFitHeight(48);
        icon.setFitWidth(48);
    ...
    public void addBeaconButton() {
        ...
        ImageView icon = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/beacon.png")));
        icon.setFitHeight(48);
        icon.setFitWidth(48);
