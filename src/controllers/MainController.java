    ...
    public void changeScene(int view) throws IOException {
        ...
        switch(view){
            case PAGE_MAIN : loader = new FXMLLoader(getClass().getResource("/views/MainMenu.fxml"));
                             game = new GoldMiner();
                break;
            case PAGE_MINER : loader = new FXMLLoader(getClass().getResource("/views/MinerMenu.fxml"));
                break;
            case PAGE_SMART : loader = new FXMLLoader(getClass().getResource("/views/SmartBoard.fxml"));
                break;
            case PAGE_RANDOM : loader = new FXMLLoader(getClass().getResource("/views/RandomBoard.fxml"));
                break;
            case CREDITS: loader = new FXMLLoader(getClass().getResource("/views/Credits.fxml"));
                break;
        }
