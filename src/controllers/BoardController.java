...
//        board.getStyleClass().add("GridLines");
     ...
     */
    public void load() {
        imageView = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/avatar_E.gif")));
    ...
    private void addPit(int x, int y){
        board.add(new ImageView(new Image(getClass().getResourceAsStream("/views/resources/p.png"))), x, y);
    }

    private void addBeacon(int x, int y){
        board.add(new ImageView(new Image(getClass().getResourceAsStream("/views/resources/b.png"))), x, y);
    }

    private void addGold(int x, int y){
        board.add(new ImageView(new Image(getClass().getResourceAsStream("/views/resources/g.png"))), x, y);
    }
    ...
    public void changeDirection(char direction){
        ...
        switch (direction){
            case 'N': imageView = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/avatar_N.gif")));
                minerFace = 'N';
                break;
            case 'S': imageView = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/avatar_S.gif")));
                minerFace = 'S';
                break;
            case 'W': imageView = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/avatar_W.gif")));
                minerFace = 'W';
                break;
            case 'E': imageView = new ImageView(new Image(getClass().getResourceAsStream("/views/resources/avatar_E.gif")));
                minerFace = 'E';
                break;
        }
    }
